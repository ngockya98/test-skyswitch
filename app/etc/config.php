...
return [
    'modules' => [
        ...
        'Klarna_KpGraphQl' => 1,
        'Magedelight_Base' => 1,
        'Magedelight_Authorizecim' => 1,
        'NtsDirect_Service' => 1,
        'PayPal_Braintree' => 1,
        'PayPal_BraintreeGraphQl' => 1,
        'Revio_Service' => 1,
        'Shipwire_Service' => 1,
        'SkySwitch_Accounts' => 1,
        'SkySwitch_Auth' => 0,
        'SkySwitch_Contracts' => 1,
        'SkySwitch_CustomTheme' => 1,
        'SkySwitch_Distributors' => 1,
        'SkySwitch_Orders' => 1,
        'SkySwitch_Payments' => 1,
        'SkySwitch_PricingCalculator' => 1,
        'SkySwitch_Products' => 1,
        'SkySwitch_Taxes' => 1,
        'Teledynamics_Service' => 1,
